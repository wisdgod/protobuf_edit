//! The groupless one-shot adopt: owned input under transactional
...
//! [`Adopt::descend`], whose verdict is resident. Descent is an
...
//! normalizes them.
//!
//! Coordinates: write · buffered · offline · groupless · tolerant (type-level) · owned · commit-only.
//!
//! # Examples
//!
//! ```
...
crate::editor::groupless::one_shot_machine! {
    ...
    /// `transfer-adopt-groupless`) adds whole-record relocation,
    ...
    a_noun: "an adopt",
    A_noun: "An adopt",
    doc_mod: "protobuf_edit::adopt::groupless",
