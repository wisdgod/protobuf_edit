//! The groupless stream-ingest adopt's transfer sibling.
//!
...
crate::editor::groupless::one_shot_machine! {
    ...
    a_noun: "an adopt",
    A_noun: "An adopt",
    doc_mod: "protobuf_edit::stream_adopt::groupless::transfer",
    doc_open: "{ let mut ingest = protobuf_edit::stream_adopt::groupless::Ingest::new(DepthLimit::REFERENCE); ingest.feed(&msg).unwrap(); ingest.finish_transfer() }",
    doc_open_empty: "protobuf_edit::stream_adopt::groupless::Ingest::new(DepthLimit::REFERENCE).finish_transfer()",
...
impl Ingest {
    ...
    /// use protobuf_edit::stream_adopt::groupless::transfer::InsertAt;
    ///
