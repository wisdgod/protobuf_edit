//! The groupless stream-ingest adopt: chunked input parsed as it
...
//!
//! Coordinates: write · stream · offline · groupless · tolerant (type-level) · owned · commit-only.
//!
//! # Examples
//!
//! ```
...
//! adopt.set_payload(tops[1], b"no").unwrap();
//!
...
crate::editor::groupless::one_shot_machine! {
    ...
    /// `transfer-stream-adopt-groupless`) seals through
    ...
    a_noun: "an adopt",
    A_noun: "An adopt",
    doc_mod: "protobuf_edit::stream_adopt::groupless",
    doc_open: "{ let mut ingest = protobuf_edit::stream_adopt::groupless::Ingest::new(DepthLimit::REFERENCE); ingest.feed(&msg).unwrap(); ingest.finish() }",
    doc_open_empty: "protobuf_edit::stream_adopt::groupless::Ingest::new(DepthLimit::REFERENCE).finish()",
...
crate::editor::groupless::one_shot_machine! {
    ...
    A_noun: "An adopt",
    doc_mod: "protobuf_edit::stream_adopt::groupless",
    doc_open: "{ let mut ingest = protobuf_edit::stream_adopt::groupless::Ingest::new(DepthLimit::REFERENCE); ingest.feed(&msg).unwrap(); ingest.finish_borrow() }",
    doc_open_empty: "protobuf_edit::stream_adopt::groupless::Ingest::new(DepthLimit::REFERENCE).finish_borrow()",
...
crate::editor::groupless::one_shot_machine! {
    ...
    A_noun: "An adopt",
    doc_mod: "protobuf_edit::stream_adopt::groupless",
    doc_open: "{ let mut ingest = protobuf_edit::stream_adopt::groupless::Ingest::new(DepthLimit::REFERENCE); ingest.feed(&msg).unwrap(); ingest.finish_copy() }",
    doc_open_empty: "protobuf_edit::stream_adopt::groupless::Ingest::new(DepthLimit::REFERENCE).finish_copy()",
...
impl Ingest {
    ...
    /// with the chunk [`ChunkDisposition::Unabsorbed`]. Wire and
    /// capability faults ([`IngestFaultKind::Wire`],
