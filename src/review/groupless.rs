//! The groupless editing review: handle-based edits with precise
...
//! LEN payloads stay opaque until [`Review::descend`], whose
//! verdict is resident.
//!
...
//!
//! Coordinates: write · buffered · offline · groupless · canonical (type-level) · borrowed · revisable.
//!
//! # Examples
//!
//! ```
//! use protobuf_edit::review::groupless::Review;
//!
...
//! assert_eq!(review.payload_bytes(tops[1]).unwrap(), [0x68, 0x69]);
//!
//! review.set_payload(tops[1], &[0x79, 0x6F]).unwrap();
...
crate::revise::groupless::revising_machine! {
    ...
    doc_mod: "protobuf_edit::review::groupless",
}
...
crate::revise::groupless::revising_machine! {
    ...
    #[doc = " `TransferBorrowReview` (feature `transfer-review-groupless`)"]
...
crate::revise::groupless::revising_machine! {
    ...
    #[doc = ""]
    #[doc = " ```"]
    #[doc = " use protobuf_edit::review::groupless::MixReview;"]
    #[doc = ""]
