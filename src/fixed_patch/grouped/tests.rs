//! The grouped fixed patch cell's scoped rows: the slab-demand
...
fn the_slab_judgment_is_exact_at_any_address() {
    // Group f1 { varint f2=5 } · varint f1=150: the eager scan
    // materializes the closure, three rows.
    let doc = [0x0B, 0x10, 0x05, 0x0C, 0x08, 0x96, 0x01];
