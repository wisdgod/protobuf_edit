//! The groupless session's transfer siblings.
//!
...
crate::revise::groupless::revising_machine! {
    ...
    doc_mod: "protobuf_edit::session::groupless::transfer",
}
...
crate::revise::groupless::revising_machine! {
    ...
    #[doc = " sendable::<protobuf_edit::session::groupless::TransferSession>();"]
    #[doc = " ```"]
...
crate::revise::groupless::revising_machine! {
    ...
    #[doc = " ```compile_fail"]
    #[doc = " fn sendable<T: Send>() {}"]
    #[doc = " sendable::<protobuf_edit::session::groupless::TransferBorrowSession<'static>>();"]
    #[doc = " ```"]
...
crate::revise::groupless::revising_machine! {
    ...
    frame_doc: [
        ...
        #[doc = " ```compile_fail"]
        #[doc = " fn sendable<T: Send>() {}"]
        #[doc = " sendable::<protobuf_edit::session::groupless::transfer::PayloadFrame<'static>>();"]
        #[doc = " ```"]
    ],
    sized_doc: [
        #[doc = ""]
        ...
        #[doc = " ```compile_fail"]
        #[doc = " fn sendable<T: Send>() {}"]
        #[doc = " sendable::<protobuf_edit::session::groupless::transfer::SizedPayloadFrame<'static>>();"]
        #[doc = " ```"]
    ],
}
...
crate::revise::groupless::revising_machine! {
    ...
    #[doc = " ```compile_fail"]
    #[doc = " fn sendable<T: Send>() {}"]
    #[doc = " sendable::<protobuf_edit::session::groupless::PricedTransferSession>();"]
    #[doc = " ```"]
    #[doc = ""]
    #[doc = " # Examples"]
    #[doc = ""]
    #[doc = " ```"]
    #[doc = " use protobuf_edit::session::groupless::TransferSession;"]
    #[doc = ""]
...
crate::revise::groupless::revising_machine! {
    ...
    frame_doc: [
        ...
        #[doc = " ```compile_fail"]
        #[doc = " fn sendable<T: Send>() {}"]
        #[doc = " sendable::<protobuf_edit::session::groupless::transfer::PricedPayloadFrame<'static>>();"]
        #[doc = " ```"]
    ],
    sized_doc: [
        #[doc = ""]
        ...
        #[doc = " ```compile_fail"]
        #[doc = " fn sendable<T: Send>() {}"]
        #[doc = " sendable::<protobuf_edit::session::groupless::transfer::PricedSizedPayloadFrame<'static>>();"]
        #[doc = " ```"]
    ],
}
