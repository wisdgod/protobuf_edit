//! The grouped editing session: handle-based edits with precise
...
//! never stored or re-judged. Group records materialize eagerly at
//! scan (the scan is the parse; the open-group chain is the row
//! arena itself, so nesting costs no stack); LEN payloads stay
//! opaque until [`Session::descend`], whose verdict is resident —
...
//!
//! Coordinates: write · buffered · offline · grouped · canonical (type-level) · owned · revisable.
//!
//! # Examples
//!
//! ```
...
//! let inner = session.children(tops[1]).unwrap().next().unwrap();
//! assert_eq!(session.varint_word(inner).unwrap(), 1);
//!
//! // Replace the first record's value; untouched bytes ride
//! // verbatim through the save.
//! session.set_varint(tops[0], 7).unwrap();
//! let saved = session.save().unwrap();
//! assert_eq!(saved[..], [0x08, 0x07, 0x13, 0x18, 0x01, 0x14]);
//! ```
...
crate::revise::grouped::revising_machine! {
    ...
    doc_mod: "protobuf_edit::session::grouped",
}
...
crate::revise::grouped::revising_machine! {
    ...
    #[doc = " `TransferBorrowSession` (feature `transfer-session-grouped`)"]
    #[doc = " add relocation and import, and the priced wrapper"]
    #[doc = " `PricedSession` (feature `priced-session-grouped`) settles"]
    ...
    #[doc = " sendable::<protobuf_edit::session::grouped::Session>();"]
    #[doc = " ```"]
...
crate::revise::grouped::revising_machine! {
    ...
    #[doc = " ```compile_fail"]
    #[doc = " fn sendable<T: Send>() {}"]
    #[doc = " sendable::<protobuf_edit::session::grouped::BorrowSession<'static>>();"]
    #[doc = " ```"]
    #[doc = ""]
    #[doc = " # Examples"]
    #[doc = ""]
    ...
    #[doc = ""]
    #[doc = " ```"]
    #[doc = " use protobuf_edit::session::grouped::BorrowSession;"]
    #[doc = ""]
...
crate::revise::grouped::revising_machine! {
    ...
    #[doc = " ```compile_fail"]
    #[doc = " fn sendable<T: Send>() {}"]
    #[doc = " sendable::<protobuf_edit::session::grouped::MixSession<'static>>();"]
    #[doc = " ```"]
    #[doc = ""]
    #[doc = " # Examples"]
    #[doc = ""]
    ...
    #[doc = ""]
    #[doc = " ```"]
    #[doc = " use protobuf_edit::session::grouped::MixSession;"]
    #[doc = ""]
...
crate::revise::grouped::revising_machine! {
    ...
    #[doc = " and moves the prefix width per LEN level (group framing is"]
    #[doc = " fixed-width, so a group level passes the delta unchanged)."]
    #[doc = " [`PricedSession::save_len`] answers in O(1) while every"]
    #[doc = " rewritten body sits in the length class. Commands never"]
    #[doc = " refuse or saturate on caps: the accounting is exact through"]
    #[doc = " over-cap states, and the fault surfaces where the plain"]
    #[doc = " session surfaces it — at the save faces, byte-exact. A revert"]
    #[doc = " settles the same climb from the log's restored state, with"]
    #[doc = " zero allocation. The doors are [`Session::into_priced`] and"]
    ...
    #[doc = " ```compile_fail"]
    #[doc = " fn sendable<T: Send>() {}"]
    #[doc = " sendable::<protobuf_edit::session::grouped::PricedSession>();"]
    #[doc = " ```"]
    #[doc = ""]
    #[doc = " # Examples"]
    #[doc = ""]
    #[doc = " ```"]
    #[doc = " use protobuf_edit::session::grouped::Session;"]
    #[doc = ""]
    #[doc = " // varint f1=150 · group f2 { varint f3=1 }"]
    #[doc = " let msg = [0x08, 0x96, 0x01, 0x13, 0x18, 0x01, 0x14];"]
    ...
    #[doc = " let inner = {"]
    #[doc = "     let tops: Vec<_> = priced.top().collect();"]
    #[doc = "     priced.children(tops[1]).unwrap().next().unwrap()"]
    #[doc = " };"]
    #[doc = " priced.set_varint(inner, 300).unwrap();"]
    #[doc = " assert_eq!(priced.save_len(), Ok(8));"]
    #[doc = " assert_eq!(priced.save().unwrap().len(), 8);"]
    #[doc = ""]
...
crate::revise::grouped::revising_machine! {
    ...
    frame_doc: [
        ...
        #[doc = " ```compile_fail"]
        #[doc = " fn sendable<T: Send>() {}"]
        #[doc = " sendable::<protobuf_edit::session::grouped::PricedPayloadFrame<'static>>();"]
        #[doc = " ```"]
    ],
    sized_doc: [
        #[doc = ""]
        ...
        #[doc = " ```compile_fail"]
        #[doc = " fn sendable<T: Send>() {}"]
        #[doc = " sendable::<protobuf_edit::session::grouped::PricedSizedPayloadFrame<'static>>();"]
        #[doc = " ```"]
    ],
}
...
crate::revise::grouped::revising_machine! {
    ...
    frame_doc: [
        ...
        #[doc = " ```compile_fail"]
        #[doc = " fn sendable<T: Send>() {}"]
        #[doc = " sendable::<protobuf_edit::session::grouped::PayloadFrame<'static>>();"]
        #[doc = " ```"]
    ],
    sized_doc: [
        #[doc = ""]
        ...
        #[doc = " ```compile_fail"]
        #[doc = " fn sendable<T: Send>() {}"]
        #[doc = " sendable::<protobuf_edit::session::grouped::SizedPayloadFrame<'static>>();"]
        #[doc = " ```"]
    ],
}
...
crate::revise::grouped::revising_machine! {
    ...
    frame_doc: [
        ...
        #[doc = " ```compile_fail"]
        #[doc = " fn sendable<T: Send>() {}"]
        #[doc = " sendable::<protobuf_edit::session::grouped::MixPayloadFrame<'static, 'static>>();"]
        #[doc = " ```"]
    ],
    sized_doc: [
        #[doc = ""]
        ...
        #[doc = " ```compile_fail"]
        #[doc = " fn sendable<T: Send>() {}"]
        #[doc = " sendable::<protobuf_edit::session::grouped::MixSizedPayloadFrame<'static, 'static>>();"]
        #[doc = " ```"]
    ],
}
