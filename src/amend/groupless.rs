//! The groupless one-shot amend: borrowed input under
...
//! payloads stay opaque until [`Amend::descend`], whose verdict is
//! resident. Descent is an explicit commitment: nothing here
...
//! canonical admission.
//!
//! Coordinates: write · buffered · offline · groupless · canonical (type-level) · borrowed · commit-only.
//!
//! # Examples
//!
//! ```
...
//! amend.set_payload(tops[1], b"no").unwrap();
//!
...
crate::editor::groupless::one_shot_machine! {
    ...
    /// `transfer-amend-groupless`) adds whole-record relocation,
    ...
    a_noun: "an amend",
    A_noun: "An amend",
    doc_mod: "protobuf_edit::amend::groupless",
